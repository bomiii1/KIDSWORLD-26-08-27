...
export default function UsageInfo() {
  return (
    <section className="bg-[#FFF9EE] px-5 py-[60px] sm:px-8 md:px-10 lg:px-[80px] lg:py-[80px] xl:px-[150px]">
      ...
      <div className="mt-[35px] grid grid-cols-1 gap-[45px] lg:grid-cols-[0.95fr_1.05fr] lg:gap-[55px]">
        {/* 왼쪽 이미지 */}
        <div className="flex flex-col gap-[18px]">
          <div className="overflow-hidden rounded-[16px] bg-[#D9D9D9]">
            <img
              src="/img/usage_info1.jpg"
              alt="키즈월드 이용정보 이미지"
