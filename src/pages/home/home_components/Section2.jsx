    ...
    <section className="overflow-hidden bg-white px-5 pb-[80px] pt-[45px] sm:px-[30px] sm:pb-[100px] sm:pt-[55px] md:px-[50px] lg:px-[80px] lg:pb-[120px] lg:pt-[60px] xl:px-[150px]">
      ...
      <div className="relative mt-[40px] sm:mt-[50px]">
        ...
        <button
          type="button"
          aria-label="이전 인기시설"
          className="section2-prev absolute left-[-55px] top-[45%] z-20 hidden -translate-y-1/2 cursor-pointer items-center justify-center text-[#292929]/65 transition-all duration-300 hover:text-[#292929] lg:flex xl:left-[-70px]"
        >
        ...
        <button
          type="button"
          aria-label="다음 인기시설"
          className="section2-next absolute right-[-55px] top-[45%] z-20 hidden -translate-y-1/2 cursor-pointer items-center justify-center text-[#292929]/65 transition-all duration-300 hover:text-[#292929] lg:flex xl:right-[-70px]"
        >
